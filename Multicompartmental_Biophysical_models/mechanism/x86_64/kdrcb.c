...
#define nrn_init _nrn_init__kdrcb
#define _nrn_initial _nrn_initial__kdrcb
#define nrn_cur _nrn_cur__kdrcb
#define _nrn_current _nrn_current__kdrcb
#define nrn_jacob _nrn_jacob__kdrcb
#define nrn_state _nrn_state__kdrcb
#define _net_receive _net_receive__kdrcb 
#define rate rate__kdrcb 
#define states states__kdrcb 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrcb /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/kdrcb.mod\n");
