...
#define nrn_init _nrn_init__kcain
#define _nrn_initial _nrn_initial__kcain
#define nrn_cur _nrn_cur__kcain
#define _nrn_current _nrn_current__kcain
#define nrn_jacob _nrn_jacob__kcain
#define nrn_state _nrn_state__kcain
#define _net_receive _net_receive__kcain 
#define rates rates__kcain 
#define states states__kcain 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 kcain /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/kcain.mod\n");
