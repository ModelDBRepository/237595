...
#define nrn_init _nrn_init__GLUIN
#define _nrn_initial _nrn_initial__GLUIN
#define nrn_cur _nrn_cur__GLUIN
#define _nrn_current _nrn_current__GLUIN
#define nrn_jacob _nrn_jacob__GLUIN
#define nrn_state _nrn_state__GLUIN
#define _net_receive _net_receive__GLUIN 
#define release release__GLUIN 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GLUIN /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/ampain.mod\n");
