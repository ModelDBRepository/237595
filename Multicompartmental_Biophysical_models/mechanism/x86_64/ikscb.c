...
#define nrn_init _nrn_init__IKscb
#define _nrn_initial _nrn_initial__IKscb
#define nrn_cur _nrn_cur__IKscb
#define _nrn_current _nrn_current__IKscb
#define nrn_jacob _nrn_jacob__IKscb
#define nrn_state _nrn_state__IKscb
#define _net_receive _net_receive__IKscb 
#define rate rate__IKscb 
#define states states__IKscb 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 IKscb /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/ikscb.mod\n");
