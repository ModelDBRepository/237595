...
#define nrn_init _nrn_init__Nafin
#define _nrn_initial _nrn_initial__Nafin
#define nrn_cur _nrn_cur__Nafin
#define _nrn_current _nrn_current__Nafin
#define nrn_jacob _nrn_jacob__Nafin
#define nrn_state _nrn_state__Nafin
#define _net_receive _net_receive__Nafin 
#define rate rate__Nafin 
#define states states__Nafin 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nafin /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/nafin.mod\n");
