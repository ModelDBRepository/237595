...
#define nrn_init _nrn_init__Nafcb
#define _nrn_initial _nrn_initial__Nafcb
#define nrn_cur _nrn_cur__Nafcb
#define _nrn_current _nrn_current__Nafcb
#define nrn_jacob _nrn_jacob__Nafcb
#define nrn_state _nrn_state__Nafcb
#define _net_receive _net_receive__Nafcb 
#define rate rate__Nafcb 
#define states states__Nafcb 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nafcb /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/nafcb.mod\n");
