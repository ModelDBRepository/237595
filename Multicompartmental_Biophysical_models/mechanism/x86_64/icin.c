...
#define nrn_init _nrn_init__iCin
#define _nrn_initial _nrn_initial__iCin
#define nrn_cur _nrn_cur__iCin
#define _nrn_current _nrn_current__iCin
#define nrn_jacob _nrn_jacob__iCin
#define nrn_state _nrn_state__iCin
#define _net_receive _net_receive__iCin 
#define rate rate__iCin 
#define states states__iCin 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 iCin /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/icin.mod\n");
