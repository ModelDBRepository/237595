...
#define nrn_init _nrn_init__iCcb
#define _nrn_initial _nrn_initial__iCcb
#define nrn_cur _nrn_cur__iCcb
#define _nrn_current _nrn_current__iCcb
#define nrn_jacob _nrn_jacob__iCcb
#define nrn_state _nrn_state__iCcb
#define _net_receive _net_receive__iCcb 
#define rate rate__iCcb 
#define states states__iCcb 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 iCcb /home/cluster/aleka/MainPath/Desktop/FSBC_model/Multicompartmental_Biophysical_models/mechanism/x86_64/iccb.mod\n");
